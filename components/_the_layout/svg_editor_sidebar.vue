...
export default {
  ...
  computed: {
    svg_colors() {
      return this.$store.getters['draft_document/svg_editor/svg_colors'];
    },
    svg_color_fields() {
      let fields = [];
    ...
    selected_layer() {
      return this.$store.getters['draft_document/svg_editor/selected_layer'];
    },

    selected_layer_path() {
      return this.$store.getters['draft_document/svg_editor/selected_layer_path'];
    },
    ...
    xml_doc() {
      return this.$store.getters['draft_document/svg_editor/xml_doc'];
    },
  ...
  methods: {
    update_attr(value, field) {
      this.$store.commit('draft_document/svg_editor/update_node', {
    ...
    select_layer(path) {
      this.$store.commit('draft_document/svg_editor/select_layer', path);
    }
  },
}
</script>