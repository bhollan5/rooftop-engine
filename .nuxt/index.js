...
import nuxt_plugin_axios_bbba06be from 'nuxt_plugin_axios_bbba06be' // Source: ./axios.js (mode: 'all')
...
async function createApp (ssrContext) {
  ...
  if (typeof nuxt_plugin_axios_bbba06be === 'function') {
    await nuxt_plugin_axios_bbba06be(app.context, inject)
  }
